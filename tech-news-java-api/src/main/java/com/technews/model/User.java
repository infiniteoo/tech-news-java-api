...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return loggedIn == user.loggedIn && id.equals(user.id) && username.equals(user.username) && email.equals(user.email) && password.equals(user.password) && posts.equals(user.posts) && votes.equals(user.votes) && comments.equals(user.comments);
    }
